...
cp %{_builddir}/Algorithm-Combinatorics-0.27/deblicense/copyright %{buildroot}/usr/share/package-licenses/perl-Algorithm-Combinatorics/4ac3f33934bfa4f4c6997eb59ab63df03f2296b9
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/Algorithm/Combinatorics.pm
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/auto/Algorithm/Combinatorics/Combinatorics.so
